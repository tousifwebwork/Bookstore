...
const AboutComponent = () => {
  return (
    ...
    <style>
      ...
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 mt-15 pt-10 h-150">

        <h1 className="text-3xl font-semibold text-center">About our apps</h1>
        <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">
          A visual collection of our most recent works - each piece crafted with intention, emotion and style.
        </p>

        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 px-4 py-10">
          <img
